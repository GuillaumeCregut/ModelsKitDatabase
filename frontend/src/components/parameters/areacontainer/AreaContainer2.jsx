...
const AreaContainer2 = () => {
    ...
    const columns = [
        ...
        { field: 'id', headerName: 'Modifier', width: 130 },
        { field: 'id', headerName: 'Supprimer', width: 130 },
    ]
